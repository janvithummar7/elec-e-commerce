...
import signupImage from "../assets/banner6.png"; // Ensure the image is inside /assets
  ...
  return (
    <>
      <div className="flex justify-center items-center min-h-screen bg-gray-100">
        {/* Container with fixed width similar to home page */}
        <div className="max-w-[1200px] w-full flex flex-col lg:flex-row items-center">
          ...
          {/* Right Side - Form */}
          <div className="w-full lg:w-[40%]  bg-white p-8 rounded-lg shadow-lg">
